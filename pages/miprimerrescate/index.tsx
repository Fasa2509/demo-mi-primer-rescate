...
const MiPrimerRescatePage: NextPage = () => {
  ...
  return (
    <MainLayout title={ '¿Qué es la fundación Mi Primer Rescate?' } H1={ 'Proyecto MPR' } pageDescription={ 'Te contamos quiénes somos, qué hacemos, cuáles son nuestros objetivos y lo que hacemos para conseguirlos. ¡Conócenos!' } titleIcon={ <Pets color='info' sx={{ fontSize: '1.5rem' }} /> } nextPage='/apoyo' url='/miprimerrescate'>
